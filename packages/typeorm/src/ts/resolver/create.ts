import { compact, first, last, clone, flatten, cloneDeep } from 'es-toolkit/compat'

import type { GraphQLResolveInfo } from "graphql";
import type { DataSource, EntityManager, InsertQueryBuilder } from "typeorm";
...
import type { ModelType } from "../common";
import type { Plugin } from "../plugin";
import {
    getModelPrimaryColumn,
    getModelSelectQuery,
    hooksExecutor,
    type InputResolverInfo,
    type ModelInputMutationResolverHooks,
    throwModelNotFound
} from "./common";

export interface CreateResolverOptionsPartial {
    plugins?: Plugin[]
}

export interface CreateResolverOptions extends CreateResolverOptionsPartial {
...
export function createResolver<ModelType, SourceType=any>(options: CreateResolverOptions, hooks?: CreateResolverHooks<ModelType, SourceType>){
    ...
    return async (source: SourceType, args: AnyObject, context: any, info: GraphQLResolveInfo)=> {
