import { compact, last, pickBy, flatten, cloneDeep, clone } from 'es-toolkit/compat'

import type { GraphQLResolveInfo } from "graphql";

import type { DataSource, EntityManager, UpdateQueryBuilder } from "typeorm";
        ...
        try {
            ...
            await options.dataSource.transaction(async transaction => {
                ...
                if(hooks?.$updateModel){
                    ...
                    const updateQueryBuilder = transactionRepository.createQueryBuilder().update()
                        .set(safeUpdateData)
