...
import {
    ...
    type EntityNamingStrategy,
    EntitySchemaBuilder,
    UpdateInputObjectTypeBuilder
} from "@kiwano/core";

import type { ColumnTypeMapper, ModelBuilderOptions, ModelType } from "./common";
...
export class ModelSchemaBuilder extends AbstractEntitySchemaBuilder<
    ...
    constructor(model: ModelType, optionsOrDataSource?: ModelSchemaBuilderOptions | DataSource){
        ...
        const options = resolveModelBuilderOptions<ModelSchemaBuilderOptions, string>(optionsOrDataSource);
    ...
    override async finalizeSchema(): Promise<void> {
