import { isArray, defaults, isString } from 'es-toolkit/compat'

import { Brackets, type EntityMetadata, type SelectQueryBuilder } from "typeorm";
...
import {
    ...
    type EqualsFilterPluginFieldConfig,
    type EqualsFilterPluginOptions as CoreEqualsFilterPluginOptions,
    type InputFieldType,
    isTypeInput,
...
export class EqualsFilterPlugin extends CoreEqualsFilterPlugin implements Plugin {
    ...
    declare protected _options: EqualsFilterPluginOptions;
    ...
    protected override _getExtraFieldConfigs(context: BuildContext, name: string, targetObjectType?: ObjectTypeBuilder): Set<EqualsFilterPluginFieldConfig> {
        ...
        if(this._options.relations && targetObjectType){
            ...
            for(const relation of this._options.relations){
