import { compact, flatten, isNaN } from 'es-toolkit/compat';

import type { SelectQueryBuilder } from "typeorm";
import type { RelationMetadata } from "typeorm/metadata/RelationMetadata.js";

import { MultiPlugin as CoreMultiPlugin, type Plugin as CorePlugin } from "@kiwano/core";
...
export function cursorToOffset(cursor: string): number {
    ...
    const offset = Number.parseInt(decoded.replace(cursorPrefix, ''));
