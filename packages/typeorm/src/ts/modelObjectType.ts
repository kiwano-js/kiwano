import { flatten, isString } from 'es-toolkit/compat'
...
import {
    ...
    ObjectTypeBuilder,
    type ObjectTypeBuilderInfo
} from "@kiwano/core";

import { resolveModelBuilderOptions } from "./util";
import { type ModelBuilderOptions, type ModelType, relationIsMany } from "./common";
import { resolverOptionsExtensionName } from "./modelSchema";
import type { RelationResolverOptions } from "./resolver";
...
export class ModelObjectTypeBuilder extends ObjectTypeBuilder {
    ...
    override async finalizeObjectType(context: FinalizeContext, info: ObjectTypeBuilderInfo): Promise<any> {
