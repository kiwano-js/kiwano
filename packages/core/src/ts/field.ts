import { isString, clone } from 'es-toolkit/compat'

import type { GraphQLFieldConfig, GraphQLFieldResolver } from "graphql/type/definition";
import { type GraphQLOutputType, GraphQLNonNull, GraphQLList } from "graphql";

import { ArgumentBuilder, type ArgumentType } from "./argument";
import type { ObjectTypeBuilder } from "./objectType";
import Builder, { type BuildContext, type FinalizeContext, type BuilderName, BuilderError } from "./Builder";
...
export class FieldBuilder extends Builder<GraphQLFieldConfig<any, any>> {
    ...
    nonNullList(nonNullList = true): this {
